    ...
    try {
      ...
      if (err instanceof ApiError) {
        if (err.status === 401) {
          ...
          setErro(typeof err.body === 'string' ? err.body : "Cupom invalido.");
        }
      } else {
          ...
          <div className="lg:col-span-2">
            <SketchCard className="p-4 sm:p-6">
              ...
              <input
                ...
                className="w-full text-center text-2xl sm:text-4xl py-4 sm:py-6 px-4 bg-white border border-gray-300 outline-none focus:ring-2 focus:ring-[#22C55E] focus:border-transparent mb-4 tracking-wider"
                style={{
                  borderRadius: "8px",
              ...
              {erro && (
                <motion.div
                  ...
                  className="bg-red-100 border border-red-400 text-red-700 px-3 py-2 text-sm mb-4 rounded-lg"
                  style={{
                ...
                >
                  <SketchCard className="bg-[#22C55E]/20">
                    <div className="p-4 sm:p-6">
                      ...
                      <div
                        className="bg-white p-4 border border-gray-200 mb-4 rounded-lg"
                      >
                        <div className="flex items-center gap-3 mb-3">
                          <div
                            className="w-10 h-10 sm:w-12 sm:h-12 bg-[#F5F2E9] border border-gray-300 flex items-center justify-center flex-shrink-0 rounded-full"
                            style={{
                              fontFamily: "'Architects Daughter', cursive",
                            }}
                          >
